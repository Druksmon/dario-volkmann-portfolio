...
const WorkCard = ({data}) => {
    ...
    return (<div className='work-card-container' key={title}>
            <div style={{backgroundImage: `url(${img})`}} className="work-card-img">
                <motion.div initial={{opacity: 0}} whileHover={{opacity: 1}} onTap={{opacity: 1}}
                    ...
                    <p>{text}</p>
                    <div>
                        {ready ? (<motion.a initial={{color: "rgba(208, 208, 208, 0.8)", scale: 1}}
                            ...
                            </motion.a>) : (<motion.a initial={{color: "rgba(208, 208, 208, 0.8)", scale: 1}}
                                                      whileHover={{color: "rgba(85,143,255,0.8)", scale: 1.05}}
                                                      transition={{duration: 0.3}}
